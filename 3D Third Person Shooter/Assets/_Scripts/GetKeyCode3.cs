/* Source File Name: GetKeyCode3.cs
...
public class GetKeyCode3 : MonoBehaviour {
	...
	// If the player is within the trigger, pick up the key code3.
	void OnTriggerStay(Collider other){
		if (other.CompareTag("Player")){
			if (CrossPlatformInputManager.GetButtonDown("Fire1")){
				gameController.GotCode3();
				this.clip.Play();
				this.gameController.infoLabel.text = "02026 Code Obtained\nLost Other Codes";

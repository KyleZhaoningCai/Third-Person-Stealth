/* Source File Name: GetKeyCode2.cs
...
public class GetKeyCode2 : MonoBehaviour {
	...
	// If the player is within the trigger, pick up the key code2.
	void OnTriggerStay(Collider other){
		if (other.CompareTag("Player")){
			if (CrossPlatformInputManager.GetButtonDown("Fire1")){
				gameController.GotCode2();
				this.clip.Play();
				this.gameController.infoLabel.text = "07026 Code Obtained\nLost Other Codes";
